...
Band claims must be interpreted according to their evidence type:

- **Official Evidence** — external IELTS format, scoring, or published descriptor truth; owned in `02-IELTS-MODEL.md` and referenced here.
- **Evidence-Based Interpretation** — direct educational interpretation of official evidence.
- **Blueprint Inference** — pedagogical detail beyond what IELTS explicitly publishes.

Detailed receptive ability overlays for Listening and Reading are Blueprint Inference because public receptive scoring is primarily raw-score based rather than an analytic ability descriptor per band.

## Exit hierarchy

Exit semantics are hierarchical:

```text
task-level threshold where the skill has distinct scored tasks
        ↓
skill-level Band N threshold
        ↓
learner progression decision
```

This file owns the first two levels. `09-PROGRESSION.md` owns the state transition after sufficient evidence exists.
...
- recognize familiar words and simple propositions;
- capture selected basic details;
- begin distinguishing global meaning from isolated words.

Acceptable residual limitations:

- large gaps in comprehension;
- unreliable extended-speech tracking;
- weak paraphrase/signposting handling;
- academic monologue remains outside the expected threshold.
...
- recognize explicit details;
- use basic word matching and scanning;
- begin identifying a simple overall topic.
...
- convey basic personal/familiar meaning;
- attempt simple sentences;
- minimally connect simple responses;
- remain at least partly communicative despite frequent pauses and language search.
...
- identify main ideas in simpler recordings;
- capture common details;
- complete basic completion/short-answer tasks.
...
- scan for details;
- skim for a basic main idea;
- complete simpler completion/short-answer tasks.
...
- discuss familiar topics at a basic level;
- connect simple sentences;
- produce some accurate short utterances;
- attempt basic stress/intonation while remaining broadly intelligible.
...
- follow main points and relevant details in familiar social and some educational contexts;
- recognize common paraphrase;
- begin managing distractors;
- handle a broader range of official question types.
...
- identify main ideas and detailed explicit information;
- begin inference and text-structure reasoning;
- apply common question-type strategies beyond simple completion.
...
- keep speaking, though repetition, self-correction, or slower delivery may be needed;
- discuss familiar and unfamiliar topics with limited lexical flexibility;
- attempt paraphrase;
...
- follow main ideas and specific details across most parts;
- handle common paraphrase and question-type demands;
...
- produce long turns, even if coherence occasionally slips;
- generally paraphrase successfully;
...
- follow extended speech reliably;
- handle academic/abstract content;
- recognize paraphrase and signposting consistently;
...
- handle extended and complex passages reliably;
- infer meaning and writer stance;
...
- present a clear developed position;
...
- some flexible use of cohesion and reference;
...
- produce long turns without noticeable effort;
- develop topics coherently;
- use discourse markers flexibly;
...
- understand detailed, complex, and abstract speech with little difficulty;
...
- address the prompt appropriately and sufficiently;
...
- wide, flexible, precise lexical resource;
...
- speak fluently with hesitation mostly related to content rather than language search;
- use wide, flexible, precise vocabulary;
...
- full lexical flexibility and precision;
...
- fluent, coherent, fully developed speech;
- total or near-total flexibility and precision of lexical resource;
- highly accurate structural control;
- flexible connected-speech features;
...
A learner at Band N may retain errors explicitly compatible with Band N. Features characteristic of higher bands should not become mandatory Band-N exit conditions.
