...
Use the minimum justified hard gates. Runtime enforcement belongs to `09-PROGRESSION.md`.

# Canonical node registry

`Depends` records explicit sequencing relationships. Every node also inherits prerequisite semantics from referenced Skill/Knowledge graphs. Every coded reference below is a complete stable ID; prose such as "prior Band-3 nodes" is intentionally not an object reference.
...
| `C-B3-06` | Receptive gist and detail | `L-COMP-01`, `L-COMP-02`, `R-COMP-01`, `R-COMP-02` | `K-VOC-010` | `C-B3-04` recommended | Identify gist and key details in simple spoken/written input. |
...
| `C-B3-08` | Foundation integration | Band-3 foundation set | — | all prior Band-3 nodes recommended | Integrate Band-3 foundations; orchestration checkpoint, not a four-skill certification gate. |
...
| `C-B4-07` | Band-4 integration | Band-4 target set | — | all prior Band-4 nodes recommended | Integrate Band-4 work; non-certifying orchestration checkpoint. |
...
| `C-B5-02` | Cohesion and logical progression | `W-CC-02`, `W-CC-03`, `W-CC-04` | `K-GRA-022`, `K-GRA-033` | `W-CC-01`; `C-B5-01` recommended | Organize responses with progression, linking, reference and substitution. |
| `C-B5-03` | Task-2 position, development, relevance | `W-TR-02`, `W-TR-03`, `W-TR-04` | `K-VOC-012` | `W-TR-01`; `C-B5-02` recommended | Write a relevant Task-2 response with a clear position and supported ideas. |
...
| `C-B5-06` | Speaking fluency, complexity, pronunciation | `S-FC-02`, `S-FC-03`, `S-FC-04`, `S-FC-05`, `S-GRA-02`, `S-LR-02`, `S-P-02`, `S-P-03` | `K-GRA-021`, `K-VOC-012` | `S-FC-01`, `S-P-01`; `C-B5-01` recommended | Sustain an extended coherent turn using more complex language and controlled stress/intonation. |
...
| `C-B5-09` | Band-5 integration | Band-5 target set | — | all prior Band-5 nodes recommended | Integrate Band-5 capabilities; non-certifying orchestration checkpoint. |
...
| `C-B6-06` | Band-6 integration | Band-6 target set | — | all prior Band-6 nodes recommended | Integrate Band-6 accuracy/clarity; non-certifying orchestration checkpoint. |
...
| `C-B7-06` | Band-7 integration | Band-7 target set | — | all prior Band-7 nodes recommended | Integrate Band-7 flexible control; non-certifying orchestration checkpoint. |
...
| `C-B8-05` | Band-8 integration | Band-8 target set | — | all prior Band-8 nodes recommended | Integrate Band-8 high competence; non-certifying orchestration checkpoint. |
...
Every Curriculum Node references canonical objects. New nodes require a distinct orchestration purpose, not merely another lesson/exercise. Concrete lessons and exercise instances belong to `10-CONTENT-MODEL.md`.