...
- Any uncertainty in baseline resolution, diff parsing, classification, path ownership, submodule handling, or critical-path impact falls back to full `./verify`.
...
No package/test narrowing is used in v1.
