...
- [`assessment/decisions.md`](../assessment/decisions.md) — AM-001 Assessment Model rules (canonical layer, independent from Practice, 8 questions, reference by `id`); AM-002 Assessment Type schema.
