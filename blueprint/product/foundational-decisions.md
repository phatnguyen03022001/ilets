...
- [`knowledge/decisions.md`](../knowledge/decisions.md) — KK-001 Knowledge Graph rules (atomic objects, stable IDs, explicit edges, resolve Skill prereqs); KK-002 Knowledge Object schema.
